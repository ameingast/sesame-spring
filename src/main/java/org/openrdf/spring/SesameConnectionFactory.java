...
/**
 * <p>{@link SesameConnectionFactory} handles connections to the corresponding {@link Repository} and manages
 ...
 */
public class SesameConnectionFactory implements DisposableBean {
    private final ThreadLocal<SesameTransactionObject> localTransactionObject;

    private Repository repository;

    public SesameConnectionFactory(Repository repository) {
    ...
    public String toString() {
        return "SesameConnectionFactory{" +
